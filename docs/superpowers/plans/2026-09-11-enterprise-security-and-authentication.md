...
- [x] **Step 4: Executar testes de configurações**
  Executar `.venv\Scripts\pytest.exe tests/test_production_settings.py`.
- [x] **Step 5: Commit das configurações**
...
- [x] **Step 1: Escrever teste unitário falhando para crypto e modelos (RED)**
...
- [x] **Step 6: Executar teste e validar sucesso (GREEN)**
  `.venv\Scripts\pytest.exe tests/test_security_models.py`
- [x] **Step 7: Commit dos modelos**
...
- [x] **Step 1: Escrever teste unitário para autenticação combinada (RED)**
...
- [x] **Step 1: Escrever teste de API para login e gestão de chaves (RED)**
...
- [x] **Step 1: Escrever teste de throttling (RED)**
...
- [x] **Step 3: Implementar throttling.py**
  Classes `AuthRateThrottle` e `TenantApiKeyRateThrottle`.
- [x] **Step 4: Conectar throttles nas views de autenticação**
- [x] **Step 5: Executar teste e validar sucesso (GREEN)**
  `.venv\Scripts\pytest.exe tests/test_security_throttling.py`
- [x] **Step 6: Commit do throttling**
...
- [x] **Step 1: Criar helper de autenticação em conftest.py**
...
- [x] **Step 1: Implementar comando de gestão setup_security_admin**
...
- [x] **Step 2: Atualizar SPECTACULAR_SETTINGS com BearerAuth e ApiKeyAuth**
  Adicionar esquemas OpenAPI para JWT e API Key.
- [x] **Step 3: Testar `/api/v1/docs/` e `/api/v1/schema/`**
  Validar geração do schema sem erros e renderização da UI.
- [x] **Step 4: Executar suíte completa de testes e linter**
  `.venv\Scripts\pytest.exe`
  `.venv\Scripts\ruff.exe check .`
- [x] **Step 5: Commit final e push para origin/main**
