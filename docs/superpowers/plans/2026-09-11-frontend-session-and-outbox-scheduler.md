...
- [x] **Step 1: Criar testes unitários para /api/v1/auth/me/ e /api/v1/auth/switch-workspace/ (RED)**
...
- [x] **Step 3: Implementar serializers de perfil e troca de workspace**
...
- [x] **Step 1: Criar teste unitário para assinatura HMAC de webhooks (RED)**
...
- [x] **Step 3: Implementar função de assinatura e injeção no conector Webhook**
...
- [x] **Step 4: Executar testes e validar aprovação (GREEN)**
...
- [x] **Step 1: Criar testes para status do outbox e retry de dead-letter (RED)**
...
- [x] **Step 2: Atualizar deploy/easypanel.md**
  Incluir instruções para monitorar os workers Celery e a fila de Outbox.
- [x] **Step 3: Executar a suíte completa de testes e linter**
  Executar `.venv\Scripts\pytest.exe` e `.venv\Scripts\ruff.exe check .`.
- [x] **Step 4: Commit da documentação e encerramento**
