  ...
  return (
    <div className="space-y-6 max-w-[1440px] mx-auto pb-8">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          <h1 className="text-xl font-bold text-slate-900 tracking-tight">Painel Geral</h1>
          <p className="text-xs text-slate-500 mt-0.5">
            Visão consolidada de inteligência cadastral, entregabilidade RFC 5321 e saldo contábil.
          </p>
        </div>
        <div className="flex items-center gap-2">
          ...
          <button
            ...
            className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-lg border border-slate-200 bg-white hover:bg-slate-50 text-slate-700 text-xs font-medium shadow-xs transition-colors"
          >
      ...
      {/* 2. Balanced Metric Cards */}
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        {/* KPI 1: Contas e Decisores */}
        <div className="p-4 bg-white rounded-xl border border-slate-200 shadow-xs">
          <div className="flex items-center justify-between text-slate-500">
            <span className="text-xs font-medium">Contas PJ & Decisores</span>
            <Building2 className="w-4 h-4 text-slate-400" />
          </div>
          <div className="mt-2 text-xl font-bold text-slate-900">
            {metricValue(companiesCount)} <span className="text-xs font-normal text-slate-500">empresas</span>
          </div>
        ...
        <div className="p-4 bg-white rounded-xl border border-slate-200 shadow-xs">
          <div className="flex items-center justify-between text-slate-500">
            <span className="text-xs font-medium">Entregabilidade Zero-Bounce</span>
          ...
          <p className="mt-1 text-xs text-slate-500 truncate">
            {metricValue(validEmails)} caixas validadas RFC 5321
          </p>
        </div>
        ...
        <div
          ...
          className="p-4 bg-white rounded-xl border border-slate-200 shadow-xs hover:border-blue-300 transition-colors cursor-pointer group"
          title="Abrir Carteira & Ledger Contábil"
        >
          <div className="flex items-center justify-between text-slate-500">
            <span className="text-xs font-medium">Carteira & Ledger</span>
          ...
          <div className="mt-2 text-xl font-bold text-slate-900 truncate">
            {formatCredits(wallet?.available_balance ?? wallet?.balance)} <span className="text-xs font-normal text-slate-500">créditos</span>
          </div>
        ...
        <div
          ...
          className="p-4 bg-white rounded-xl border border-slate-200 shadow-xs hover:border-blue-300 transition-colors cursor-pointer group"
          title="Abrir Diagnóstico de Qualidade"
        >
          <div className="flex items-center justify-between text-slate-500">
            <span className="text-xs font-medium">Índice de Confiabilidade</span>
      ...
      {/* 3. Analytics & Operational Intelligence */}
      <div className="grid gap-6 xl:grid-cols-[1.3fr_0.7fr]">
