    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('ADMIN', 'Administrador'), ('OPERATOR', 'Operador'), ('READ_ONLY', 'Somente Leitura')], default='OPERATOR', max_length=20)),
            ...
            options={
                ...
                'indexes': [models.Index(fields=['prefix', 'is_active'], name='security_ap_prefix_2e2aae_idx')],
            },
        ),
        migrations.CreateModel(
            ...
            options={
                ...
                'indexes': [models.Index(fields=['tenant', 'timestamp'], name='security_au_tenant__78b36d_idx'), models.Index(fields=['action', 'timestamp'], name='security_au_action_0492cf_idx')],
            },
        ),
        migrations.CreateModel(
            ...
            options={
                ...
                'indexes': [models.Index(fields=['user', 'tenant', 'is_active'], name='security_wo_user_id_fb7b7e_idx')],
